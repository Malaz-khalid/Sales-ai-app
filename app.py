...
if st.button("🚀 Predict"):
    ...
    if discount > 0.5:
        ...
        recommendations.append("💡 You can increase discount slightly to boost sales")
    ...
    if category == "Technology":
        recommendations.append("💻 Technology products have high revenue potential")

    elif category == "Furniture":
        recommendations.append("🪑 Furniture sales are slower — consider promotions")

    else:
        recommendations.append("📎 Office Supplies are stable but low margin")

    if segment == "Corporate":
        recommendations.append("🏢 Corporate customers generate bulk purchases")

    elif segment == "Consumer":
        recommendations.append("🧑 Focus on marketing campaigns for consumers")

    else:
        recommendations.append("🏠 Home Office segment is seasonal")

    for rec in recommendations:
        st.info(rec)

    if len(recommendations) == 0:
        st.success("✅ Your settings look optimal for sales performance")
